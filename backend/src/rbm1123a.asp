...
function AbreLeituraOcrSimples(linha) {
    var pagina = '';
	pagina += '../../rbm/asp/rbm1123c.asp?PT=<%=txt_subtitulo%>';
	 if (document.form01.num_reembolso.value != '') {
     pagina += '&num_reembolso=' + document.form01.num_reembolso.value;
    }
...
<table border=0 width="100%">
    ...
    <tr>
         ...
         <tr bgcolor="#e2eFe5">
            ...
            <td width="1%" class="label_left">Anexo&nbsp;</td>  
			<td width="1%" class="label_left">OCR&nbsp;</td>
        </tr>
    </tr>
    <%
        dim i
		...
		<td style="text-align: center;">
			<a href='<%= rsPesquisa("nom_arq_anexo") %>' target="_blank" onclick="AlteraIcone(<%= i %>)">
			<img id="clips_<%= i %>" border="0" src="\gen\img\clips_1.gif" alt='<%= rsPesquisa("nom_arq_anexo") %>'>
			</a>


		<td style="text-align: center;">			
         <img id="leitura_ocr" name="leitura_ocr" width="16" height="16" src="/gen/img/conf_exec_.png" border="0" title="Leitura OCR" style="cursor:hand;" onclick="AbreLeituraOcrSimples();">
		</td>
